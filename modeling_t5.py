...
class T5EncoderStack(T5PreTrainedModel):
    def __init__(self, config, embed_tokens=None):
        ...
        self.prefix_first = nn.Parameter(torch.empty(self.pre_seq_len, self.bottle_neck))
        self.prefix_second = nn.Parameter(torch.empty(self.bottle_neck, config.d_model))
        
        self.init_prefix_weights(self.prefix_first, self.prefix_second)
        
        self.ensemble_prompts = None
    ...
    def init_prefix_weights(self, params1, params2):
        random_range = 0.5 
        params1.data.uniform_(-random_range, random_range)
        params2.data.uniform_(-random_range, random_range)
    ...
    def get_prompt_encoder(self, batch_size, task_ids):
        ...
        batch_prompts = torch.matmul(self.prefix_first, self.prefix_second)
